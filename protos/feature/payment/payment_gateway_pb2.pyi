...
class PaymentGateway(_message.Message):
    ...
    class PaymentProcessorMeta(_message.Message):
        __slots__ = ("flow", "imageUrl", "applicationPackageName", "number", "balance", "image", "label", "stringified_app_click_action", "stringified_app_on_load_action", "use_async_init", "auto_trigger_payment_init", "unavailable")
        ...
        AUTO_TRIGGER_PAYMENT_INIT_FIELD_NUMBER: _ClassVar[int]
