...
from action import share_pb2 as _share_pb2
from action import widget_navigation_pb2 as _widget_navigation_pb2
from action import fetch_widget_pb2 as _fetch_widget_pb2
...
from action import login_action_pb2 as _login_action_pb2
from action import subscribe_action_pb2 as _subscribe_action_pb2
from action import mail_to_pb2 as _mail_to_pb2
from action import go_back_pb2 as _go_back_pb2
from action import hs_track_pb2 as _hs_track_pb2
from action import appsflyer_track_pb2 as _appsflyer_track_pb2
from action import logout_action_pb2 as _logout_action_pb2
from action import page_event_pb2 as _page_event_pb2
from action import cancel_subscription_pb2 as _cancel_subscription_pb2
from action import open_widget_overlay_pb2 as _open_widget_overlay_pb2
from action import open_page_overlay_pb2 as _open_page_overlay_pb2
from action import add_to_search_history_pb2 as _add_to_search_history_pb2
from action import change_language_pb2 as _change_language_pb2
from action import fetch_start_pb2 as _fetch_start_pb2
from action import change_privacy_preferences_pb2 as _change_privacy_preferences_pb2
from action import close_overlay_pb2 as _close_overlay_pb2
from action import reinitiate_last_payment_pb2 as _reinitiate_last_payment_pb2
from action import gtm_track_pb2 as _gtm_track_pb2
from action import rate_app_pb2 as _rate_app_pb2
from action import load_pg_form_pb2 as _load_pg_form_pb2
from action import post_payment_navigation_pb2 as _post_payment_navigation_pb2
from action import show_toast_pb2 as _show_toast_pb2
from action import bridge_event_pb2 as _bridge_event_pb2
from action import generate_recaptcha_token_pb2 as _generate_recaptcha_token_pb2
from action import reload_pb2 as _reload_pb2
from action import dismiss_notification_pb2 as _dismiss_notification_pb2
from action import deeplink_pb2 as _deeplink_pb2
from action import form_input_pb2 as _form_input_pb2
from action import form_validation_pb2 as _form_validation_pb2
from action import fetch_page_pb2 as _fetch_page_pb2
from action import invoke_http_url_action_pb2 as _invoke_http_url_action_pb2
from action import invoke_sna_url_action_pb2 as _invoke_sna_url_action_pb2
from action import invalidate_proxy_state_pb2 as _invalidate_proxy_state_pb2
from action import upsert_routing_table_query_param_pb2 as _upsert_routing_table_query_param_pb2
from action import verify_sna_pb2 as _verify_sna_pb2
from action import delete_list_item_pb2 as _delete_list_item_pb2
from action import login_via_encrypted_id_pb2 as _login_via_encrypted_id_pb2
from action import app_restart_pb2 as _app_restart_pb2
from action import watchlist_pb2 as _watchlist_pb2
from action import subscribe_message_pb2 as _subscribe_message_pb2
from action import publish_message_pb2 as _publish_message_pb2
from action import form_input_reset_pb2 as _form_input_reset_pb2
from action import form_reset_pb2 as _form_reset_pb2
from action import show_tooltip_pb2 as _show_tooltip_pb2
...
from action import check_permission_status_pb2 as _check_permission_status_pb2
from action import redirect_to_device_settings_pb2 as _redirect_to_device_settings_pb2
from action import player_control_action_pb2 as _player_control_action_pb2
from action import initiate_payment_pb2 as _initiate_payment_pb2
from action import form_submit_pb2 as _form_submit_pb2
from action import remind_me_pb2 as _remind_me_pb2
from action import preload_pb2 as _preload_pb2
from action import toggle_visibility_pb2 as _toggle_visibility_pb2
from action import update_cache_pb2 as _update_cache_pb2
from action import poll_get_charge_action_pb2 as _poll_get_charge_action_pb2
from action import search_chrome_cast_device_pb2 as _search_chrome_cast_device_pb2
from action import update_widget_state_pb2 as _update_widget_state_pb2
from action import check_cast_status_pb2 as _check_cast_status_pb2
from action import in_app_update_pb2 as _in_app_update_pb2
from action import accessibility_announce_pb2 as _accessibility_announce_pb2
from action import preload_webview_pb2 as _preload_webview_pb2
from action import show_sticky_menu_toast_pb2 as _show_sticky_menu_toast_pb2
from action import repeated_frequency_capped_status_pb2 as _repeated_frequency_capped_status_pb2
from action import repeated_frequency_capped_update_pb2 as _repeated_frequency_capped_update_pb2
from action import tracker_pb2 as _tracker_pb2
from action import update_dialog_widget_free_timer_from_cps_pb2 as _update_dialog_widget_free_timer_from_cps_pb2
...
class Actions(_message.Message):
    ...
    class Action(_message.Message):
        ...
        TOGGLE_VISIBILITY_ACTION_FIELD_NUMBER: _ClassVar[int]
        UPDATE_CACHE_ACTION_FIELD_NUMBER: _ClassVar[int]
        POLL_GET_CHARGE_ACTION_FIELD_NUMBER: _ClassVar[int]
        SEARCH_CHROME_CAST_DEVICE_FIELD_NUMBER: _ClassVar[int]
        UPDATE_WIDGET_STATE_ACTION_FIELD_NUMBER: _ClassVar[int]
        CHECK_CHROME_CAST_STATUS_FIELD_NUMBER: _ClassVar[int]
        IN_APP_UPDATE_FIELD_NUMBER: _ClassVar[int]
        ACCESSIBILITY_ANNOUNCE_ACTION_FIELD_NUMBER: _ClassVar[int]
        PRELOAD_WEBVIEW_ACTION_FIELD_NUMBER: _ClassVar[int]
        SHOW_STICKY_MENU_TOAST_ACTION_FIELD_NUMBER: _ClassVar[int]
        REPEATED_FREQUENCY_CAPPED_STATUS_ACTION_FIELD_NUMBER: _ClassVar[int]
        REPEATED_FREQUENCY_CAPPED_UPDATE_ACTION_FIELD_NUMBER: _ClassVar[int]
        TRACKER_ACTION_FIELD_NUMBER: _ClassVar[int]
        UPDATE_WIDGET_FREE_TIMER_STATE_FROM_CPS_ACTION_FIELD_NUMBER: _ClassVar[int]
        UPDATE_DIALOG_WIDGET_FREE_TIMER_FROM_CPS_ACTION_FIELD_NUMBER: _ClassVar[int]
...
class AccessibilityAction(_message.Message):
    __slots__ = ("action_name", "actions")
    ACTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ACTIONS_FIELD_NUMBER: _ClassVar[int]
    action_name: str
    actions: _containers.RepeatedCompositeFieldContainer[Actions.Action]
    def __init__(self, action_name: _Optional[str] = ..., actions: _Optional[_Iterable[_Union[Actions.Action, _Mapping]]] = ...) -> None: ...

class UpdateWidgetFreeTimerStateFromCPSAction(_message.Message):
    __slots__ = ("ui_configs",)
    class TextType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        DEFAULT: _ClassVar[UpdateWidgetFreeTimerStateFromCPSAction.TextType]
        ALERT: _ClassVar[UpdateWidgetFreeTimerStateFromCPSAction.TextType]
        BRAND: _ClassVar[UpdateWidgetFreeTimerStateFromCPSAction.TextType]
    DEFAULT: UpdateWidgetFreeTimerStateFromCPSAction.TextType
    ALERT: UpdateWidgetFreeTimerStateFromCPSAction.TextType
    BRAND: UpdateWidgetFreeTimerStateFromCPSAction.TextType
    class UiConfigsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: UpdateWidgetFreeTimerStateFromCPSAction.UIConfig
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[UpdateWidgetFreeTimerStateFromCPSAction.UIConfig, _Mapping]] = ...) -> None: ...
    class UIConfig(_message.Message):
        __slots__ = ("title", "text_type", "sub_title", "cta_title", "cta_actions")
        TITLE_FIELD_NUMBER: _ClassVar[int]
        TEXT_TYPE_FIELD_NUMBER: _ClassVar[int]
        SUB_TITLE_FIELD_NUMBER: _ClassVar[int]
        CTA_TITLE_FIELD_NUMBER: _ClassVar[int]
        CTA_ACTIONS_FIELD_NUMBER: _ClassVar[int]
        title: str
        text_type: UpdateWidgetFreeTimerStateFromCPSAction.TextType
        sub_title: str
        cta_title: str
        cta_actions: _containers.RepeatedCompositeFieldContainer[Actions.Action]
        def __init__(self, title: _Optional[str] = ..., text_type: _Optional[_Union[UpdateWidgetFreeTimerStateFromCPSAction.TextType, str]] = ..., sub_title: _Optional[str] = ..., cta_title: _Optional[str] = ..., cta_actions: _Optional[_Iterable[_Union[Actions.Action, _Mapping]]] = ...) -> None: ...
    UI_CONFIGS_FIELD_NUMBER: _ClassVar[int]
    ui_configs: _containers.MessageMap[int, UpdateWidgetFreeTimerStateFromCPSAction.UIConfig]
    def __init__(self, ui_configs: _Optional[_Mapping[int, UpdateWidgetFreeTimerStateFromCPSAction.UIConfig]] = ...) -> None: ...
