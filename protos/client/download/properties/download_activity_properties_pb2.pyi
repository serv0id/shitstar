from client.download.model import download_activity_info_pb2 as _download_activity_info_pb2
...
class DownloadActivityProperties(_message.Message):
    __slots__ = ("download_session_info", "download_stat_info", "download_size_info", "download_request_info", "download_activity_info")
    ...
    DOWNLOAD_ACTIVITY_INFO_FIELD_NUMBER: _ClassVar[int]
