...
class ViewedEngagementWidgetProperties(_message.Message):
    __slots__ = ("base_properties", "current_state")
    ...
    def __init__(self, base_properties: _Optional[_Union[_quiz_base_info_pb2.QuizBaseInfo, _Mapping]] = ..., current_state: _Optional[_Union[_enum_pb2.CurrentState, str]] = ...) -> None: ...
