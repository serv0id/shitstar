...
class ViewedSectionResultProperties(_message.Message):
    __slots__ = ("base_properties", "engagement_id", "section_properties", "action_properties", "result", "section_score")
    ...
    SECTION_SCORE_FIELD_NUMBER: _ClassVar[int]
    ...
    result: _enum_pb2.Result
    section_score: int
    def __init__(self, base_properties: _Optional[_Union[_quiz_base_info_pb2.QuizBaseInfo, _Mapping]] = ..., engagement_id: _Optional[str] = ..., section_properties: _Optional[_Union[_question_section_properties_pb2.QuestionSectionProperties, _Mapping]] = ..., action_properties: _Optional[_Union[_option_action_properties_pb2.OptionActionProperties, _Mapping]] = ..., result: _Optional[_Union[_enum_pb2.Result, str]] = ..., section_score: _Optional[int] = ...) -> None: ...
