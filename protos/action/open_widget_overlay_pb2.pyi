...
class OpenWidgetOverlayAction(_message.Message):
    __slots__ = ["config", "auto_dismiss_config", "url", "widget_url", "widget_wrapper"]
    ...
    def __init__(self, config: _Optional[_Union[OpenWidgetOverlayAction.autoDismissConfig, _Mapping]] = ..., auto_dismiss_config: _Optional[_Union[OpenWidgetOverlayAction.AutoDismissConfig, _Mapping]] = ..., url: _Optional[str] = ..., widget_url: _Optional[str] = ..., widget_wrapper: _Optional[_Union[OpenWidgetOverlayAction.WidgetWrapper, _Mapping]] = ...) -> None: ...
