...
class ShowToastAction(_message.Message):
    __slots__ = ["message", "duration_type", "cta_label", "icon", "toast_type"]
    ...
    def __init__(self, message: _Optional[str] = ..., duration_type: _Optional[_Union[DurationType, str]] = ..., cta_label: _Optional[str] = ..., icon: _Optional[str] = ..., toast_type: _Optional[_Union[ToastType, str]] = ...) -> None: ...
