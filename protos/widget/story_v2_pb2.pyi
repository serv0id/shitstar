...
class StoryV2Widget(_message.Message):
    __slots__ = ("widget_commons", "data")
    class Data(_message.Message):
        __slots__ = ("common_elements", "background_elements", "foreground_elements", "bottom_element")
        ...
        class ForegroundElements(_message.Message):
            ...
            templates: _containers.RepeatedCompositeFieldContainer[StoryV2Widget.Data.Templates]
            def __init__(self, templates: _Optional[_Iterable[_Union[StoryV2Widget.Data.Templates, _Mapping]]] = ...) -> None: ...
        class BottomElement(_message.Message):
            __slots__ = ("button",)
        ...
        BOTTOM_ELEMENT_FIELD_NUMBER: _ClassVar[int]
        common_elements: StoryV2Widget.Data.CommonElements
        background_elements: StoryV2Widget.Data.BackgroundElements
        foreground_elements: StoryV2Widget.Data.ForegroundElements
        bottom_element: StoryV2Widget.Data.BottomElement
        def __init__(self, common_elements: _Optional[_Union[StoryV2Widget.Data.CommonElements, _Mapping]] = ..., background_elements: _Optional[_Union[StoryV2Widget.Data.BackgroundElements, _Mapping]] = ..., foreground_elements: _Optional[_Union[StoryV2Widget.Data.ForegroundElements, _Mapping]] = ..., bottom_element: _Optional[_Union[StoryV2Widget.Data.BottomElement, _Mapping]] = ...) -> None: ...
    WIDGET_COMMONS_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NUMBER: _ClassVar[int]
    widget_commons: _widget_commons_pb2.WidgetCommons
    data: StoryV2Widget.Data
    def __init__(self, widget_commons: _Optional[_Union[_widget_commons_pb2.WidgetCommons, _Mapping]] = ..., data: _Optional[_Union[StoryV2Widget.Data, _Mapping]] = ...) -> None: ...
