...
class MyPageData(_message.Message):
    __slots__ = ("page_data_commons", "is_subscribed")
    ...
    is_subscribed: bool
    def __init__(self, page_data_commons: _Optional[_Union[_page_data_commons_pb2.PageDataCommons, _Mapping]] = ..., is_subscribed: bool = ...) -> None: ...
