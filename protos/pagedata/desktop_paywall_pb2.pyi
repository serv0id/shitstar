...
class DesktopPaywallPageData(_message.Message):
    ...
    auto_trigger_action: DesktopPaywallPageData.AutoTriggerActions
    page_event_actions: _containers.MessageMap[str, _actions_pb2.Actions.Action]
    def __init__(self, page_data_commons: _Optional[_Union[_page_data_commons_pb2.PageDataCommons, _Mapping]] = ..., auto_trigger_action: _Optional[_Union[DesktopPaywallPageData.AutoTriggerActions, _Mapping]] = ..., page_event_actions: _Optional[_Mapping[str, _actions_pb2.Actions.Action]] = ...) -> None: ...
