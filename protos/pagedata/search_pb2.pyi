...
class SearchPageData(_message.Message):
    __slots__ = ["page_data_commons", "query", "instrumentation_context", "tab_name", "filters", "suggested_queries", "result_one_liner"]
    ...
    def __init__(self, page_data_commons: _Optional[_Union[_page_data_commons_pb2.PageDataCommons, _Mapping]] = ..., query: _Optional[str] = ..., instrumentation_context: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., tab_name: _Optional[str] = ..., filters: _Optional[_Iterable[_Union[SearchPageData.Filter, _Mapping]]] = ..., suggested_queries: _Optional[_Iterable[_Union[SearchPageData.SuggestedQueries, _Mapping]]] = ..., result_one_liner: _Optional[str] = ...) -> None: ...
