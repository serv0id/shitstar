...
class TrayBackgroundLogoHeaderPageData(_message.Message):
    __slots__ = ("page_data_commons", "background_image", "page_event_actions")
    ...
    def __init__(self, page_data_commons: _Optional[_Union[_page_data_commons_pb2.PageDataCommons, _Mapping]] = ..., background_image: _Optional[_Union[_image_pb2.Image, _Mapping]] = ..., page_event_actions: _Optional[_Mapping[str, _actions_pb2.Actions.Action]] = ...) -> None: ...
