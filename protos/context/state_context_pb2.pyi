...
class ActionContext(_message.Message):
    ...
    ad_action_context: AdActionContext
    def __init__(self, subscribe_action_context: _Optional[_Union[SubscribeActionContext, _Mapping]] = ..., watch_action_context: _Optional[_Union[WatchActionContext, _Mapping]] = ..., onboarding_action_context: _Optional[_Union[OnboardingActionContext, _Mapping]] = ..., ad_action_context: _Optional[_Union[AdActionContext, _Mapping]] = ...) -> None: ...

class AdActionContext(_message.Message):
