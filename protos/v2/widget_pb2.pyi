...
from protos.v2 import refresh_widget_pb2 as _refresh_widget_pb2
...
class WidgetWrapper(_message.Message):
    __slots__ = ["template", "widget", "id", "delivery_type", "dynamic_widget_request", "deferred_widget_request", "defer_id"]
    ...
    defer_id: str
    def __init__(self, template: _Optional[str] = ..., widget: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., id: _Optional[str] = ..., delivery_type: _Optional[_Union[WidgetDeliveryType, str]] = ..., dynamic_widget_request: _Optional[_Union[_refresh_widget_pb2.RefreshWidgetRequest, _Mapping]] = ..., deferred_widget_request: _Optional[_Union[_refresh_widget_pb2.DeferredWidgetRequest, _Mapping]] = ..., defer_id: _Optional[str] = ...) -> None: ...
